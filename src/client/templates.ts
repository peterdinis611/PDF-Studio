...
function invoiceTemplate(): PdfDocument {
  ...
  els.push(
    createRect(0, 0, { width: 595, height: 90, fill: "#b0281b", strokeWidth: 0 }),
    createText(40, 28, {
      content: "INVOICE",
      fontSize: 28,
      fontWeight: "bold",
    ...
    createLine(40, 255, { width: 515, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(40, 270, {
      content:
    ...
    createLine(40, 340, { width: 515, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(340, 360, {
...
function flyerTemplate(): PdfDocument {
  ...
  const els = doc.pages[0].elements;
  els.push(
    createRect(0, 0, { width: 595, height: 842, fill: "#fcfaf5", strokeWidth: 0 }),
    createRect(40, 40, {
      width: 515,
      height: 280,
      fill: "#c43a24",
...
function cvTemplate(): PdfDocument {
  ...
  const els = doc.pages[0].elements;
  els.push(
    createRect(0, 0, { width: 200, height: 842, fill: "#1a1815", strokeWidth: 0 }),
    createText(28, 48, {
      content: "Alex Morgan",
      fontSize: 22,
      fontWeight: "bold",
    ...
    createLine(230, 78, { width: 320, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(230, 95, {
      content:
    ...
    createLine(230, 210, { width: 320, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(230, 225, {
    ...
    createLine(230, 490, { width: 320, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(230, 505, {
...
function reportTemplate(): PdfDocument {
  ...
  const els = doc.pages[0].elements;
  els.push(
    createRect(0, 0, { width: 595, height: 72, fill: "#1a1815", strokeWidth: 0 }),
    createText(40, 24, {
    ...
    createLine(40, 348, { width: 515, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(40, 365, {
      content:
    ...
    createLine(40, 488, { width: 515, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(40, 505, {
      content:
...
function certificateTemplate(): PdfDocument {
  ...
  els.push(
    ...
    createLine(180, 160, { width: 235, height: 0, stroke: "#c43a24", strokeWidth: 2 }),
    createText(80, 200, {
    ...
    createLine(90, 620, { width: 160, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(90, 635, {
      content: "Director\nAlex Morgan",
      fontSize: 12,
      color: "#544d45",
    ...
    createLine(345, 620, { width: 160, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(345, 635, {
      content: "Instructor\nSam Rivera",
      fontSize: 12,
      color: "#544d45",
...
function menuTemplate(): PdfDocument {
  ...
  const els = doc.pages[0].elements;
  els.push(
    createRect(0, 0, { width: 595, height: 100, fill: "#1a1815", strokeWidth: 0 }),
    createText(40, 28, {
    ...
    createLine(40, 160, { width: 515, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(40, 180, {
    ...
    createLine(40, 350, { width: 515, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(40, 370, {
    ...
    createLine(40, 600, { width: 515, height: 0, stroke: "#c43a24", strokeWidth: 1.5 }),
    createText(40, 620, {
...
function proposalTemplate(): PdfDocument {
  ...
  const els = doc.pages[0].elements;
  els.push(
    createRect(0, 0, { width: 595, height: 110, fill: "#1a1815", strokeWidth: 0 }),
    createText(40, 30, {
    ...
    createLine(40, 230, { width: 515, height: 0, stroke: "#a39a8e", strokeWidth: 1 }),
    createText(40, 255, {
      content: "Overview",
      fontSize: 15,
      fontWeight: "bold",
