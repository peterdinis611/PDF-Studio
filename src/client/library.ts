...
export interface LibraryItem {
  ...
  hint: string;
  tags: string[];
  kind: ElementType | `icon:${IconKind}` | `stamp:${string}` | `badge:${string}` | `preset:${string}`;
  preview: string;
}
...
export const LIBRARY_ITEMS: LibraryItem[] = [
  ...
  // Notes
  { id: "sticky", category: "notes", label: "Sticky note", hint: "Yellow memo", tags: ["note", "memo"], kind: "sticky", preview: "🗒" },
  { id: "sticky-pink", category: "notes", label: "Pink sticky", hint: "Soft pink note", tags: ["note"], kind: "preset:sticky-pink", preview: "📝" },
  { id: "sticky-mint", category: "notes", label: "Mint sticky", hint: "Mint memo", tags: ["note"], kind: "preset:sticky-mint", preview: "📗" },
  { id: "sticky-blue", category: "notes", label: "Blue sticky", hint: "Cool blue note", tags: ["note"], kind: "preset:sticky-blue", preview: "📘" },
  ...
  { id: "badge-hot", category: "notes", label: "Hot badge", hint: "Attention chip", tags: ["promo"], kind: "preset:badge-hot", preview: "🔥" },
  ...
  { id: "date", category: "presets", label: "Date stamp", hint: "Today’s date", tags: ["date"], kind: "preset:date", preview: "📅" },
  ...
  { id: "section-rule", category: "layout", label: "Section break", hint: "Title + rule", tags: ["section"], kind: "preset:section-rule", preview: "§" },
  ...
  // Data
  { id: "table", category: "data", label: "Table 3×3", hint: "Simple grid", tags: ["table"], kind: "table", preview: "▦" },
  { id: "table-wide", category: "data", label: "Table 4×5", hint: "Wider grid", tags: ["table"], kind: "preset:table-wide", preview: "▦" },
  ...
  { id: "icon-pin", category: "icons", label: "Pin", hint: "Icon", tags: ["icon"], kind: "icon:pin", preview: "📍" },
  ...
  { id: "stamp-conf", category: "stamps", label: "Confidential", hint: "Round stamp", tags: ["stamp"], kind: "stamp:CONFIDENTIAL", preview: "🔒" },
  { id: "stamp-urgent", category: "stamps", label: "Urgent", hint: "Round stamp", tags: ["stamp"], kind: "stamp:URGENT", preview: "!!" },
  { id: "stamp-copy", category: "stamps", label: "Copy", hint: "Round stamp", tags: ["stamp"], kind: "stamp:COPY", preview: "©" },
